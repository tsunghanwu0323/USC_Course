...
export class MapTabComponent implements OnChanges, OnDestroy {
  ...
  modeChosen = 'DRIVING';
  startInput = 'Your location';
  private myLocation: any;
  private panorama: any;
  buttonImgUrl = '/Users/JonathanWu/Desktop/USC CS/CSCI571-HW/test/hw8/src/assets/icons8-street-view-filled-50.png';
  modes = [
  ...
  setMap() {
    const lat = this.directions.end.lat();
    const lng = this.directions.end.lng();
  ...
  getAddressOnChange(event) {
    this.startInput = ( document.getElementById(
      'dir-start'
    ) as HTMLInputElement).value;
  }

  showPanorama() {
    const flag = this.panorama.getVisible();
    if (flag) {
      this.panorama.setVisible(false);
      this.buttonImgUrl =
        '/Users/JonathanWu/Desktop/USC CS/CSCI571-HW/test/hw8/src/assets/icons8-street-view-filled-50.png';
    } else {
